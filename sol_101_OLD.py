...
# Testing out the shape functions

                # N1 = N1.subs(
                #     {x1_o: n1_to[0, 0], x2_o: n2_to[0, 0], x3_o: n3_to[0, 0], x4_o: n4_to[0, 0], y1_o: n1_to[0, 1],
                #      y2_o: n2_to[0, 1], y3_o: n3_to[0, 1], y4_o: n4_to[0, 1],x1_n: n1_tn[0, 0], x2_n: n2_tn[0, 0], x3_n: n3_tn[0, 0], x4_n: n4_tn[0, 0], y1_n: n1_tn[0, 1],
                #      y2_n: n2_tn[0, 1], y3_n: n3_tn[0, 1], y4_n: n4_tn[0, 1]})
                # N2 = N2.subs(
                #     {x1_o: n1_to[0, 0], x2_o: n2_to[0, 0], x3_o: n3_to[0, 0], x4_o: n4_to[0, 0], y1_o: n1_to[0, 1],
                #      y2_o: n2_to[0, 1], y3_o: n3_to[0, 1], y4_o: n4_to[0, 1], x1_n: n1_tn[0, 0], x2_n: n2_tn[0, 0],
                #      x3_n: n3_tn[0, 0], x4_n: n4_tn[0, 0], y1_n: n1_tn[0, 1],
                #      y2_n: n2_tn[0, 1], y3_n: n3_tn[0, 1], y4_n: n4_tn[0, 1]})
                #
                # N3 = N3.subs(
                #     {x1_o: n1_to[0, 0], x2_o: n2_to[0, 0], x3_o: n3_to[0, 0], x4_o: n4_to[0, 0], y1_o: n1_to[0, 1],
                ...
                shape_function_sum = shape_function_sum.subs(
                    {x1_n: n1_tn[0, 0], x2_n: n2_tn[0, 0], x3_n: n3_tn[0, 0], x4_n: n4_tn[0, 0], y1_n: n1_tn[0, 1],
                     y2_n: n2_tn[0, 1], y3_n: n3_tn[0, 1], y4_n: n4_tn[0, 1]})
                # Double checking the shape function sum
                shape_function_sum = shape_function_sum.subs(
                    {x1_o: n1_to[0, 0], x2_o: n2_to[0, 0], x3_o: n3_to[0, 0], x4_o: n4_to[0, 0], y1_o: n1_to[0, 1],
                     y2_o: n2_to[0, 1], y3_o: n3_to[0, 1], y4_o: n4_to[0, 1]})
                # B = B.subs(
                #     {x1_n: n1_to[0, 0], x2_n: n2_to[0, 0], x3_n: n3_to[0, 0], x4_n: n4_to[0, 0], y1_n: n1_to[0, 1],
                #      y2_n: n2_to[0, 1], y3_n: n3_to[0, 1], y4_n: n4_to[0, 1]})
                B = B.subs(
                    {x1_n: n1_tn[0, 0], x2_n: n2_tn[0, 0], x3_n: n3_tn[0, 0], x4_n: n4_tn[0, 0], y1_n: n1_tn[0, 1],
                     y2_n: n2_tn[0, 1], y3_n: n3_tn[0, 1], y4_n: n4_tn[0, 1]})
                B = np.matrix(B)
